...
const FAQItem = ({ question, answer }: { question: string; answer: string }) => {
  ...
  return (
    <div className="border border-white/10 bg-[#0a0a0a] rounded-2xl mb-4 overflow-hidden hover:border-[#FF0000]/40 transition-colors">
      <button 
        onClick={() => setIsOpen(!isOpen)}
        className="w-full px-6 py-5 flex items-center justify-between text-left focus:outline-none"
      >
        <span className="font-bold text-white text-lg">{question}</span>
        <Plus className={`w-5 h-5 text-[#FF0000] transition-transform duration-300 ${isOpen ? "rotate-45" : ""}`} />
      </button>
      <div 
...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-white font-sans selection:bg-[#FF0000]/30 selection:text-white overflow-x-hidden">
      ...
      <main>
        {/* HERO SECTION */}
        <section className="relative pt-36 pb-20 md:pt-48 md:pb-32 overflow-hidden flex flex-col items-center text-center px-4 bg-[#000000]">
          <div className="absolute top-1/4 -left-[10%] w-[500px] h-[300px] bg-red-600/[0.08] blur-[140px] rounded-[100%] rotate-45 pointer-events-none" />
          <div className="absolute bottom-1/4 -right-[10%] w-[400px] h-[200px] bg-red-500/[0.06] blur-[120px] rounded-[100%] -rotate-45 pointer-events-none" />
          ...
          >
            <motion.div variants={fadeIn} className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-xs font-bold text-white/70 mb-8 uppercase tracking-wider">
              <span className="w-1.5 h-1.5 rounded-full bg-[#FF0000] shadow-[0_0_8px_#FF0000]"></span>
            ...
            <motion.h1 variants={fadeIn} className="font-display text-4xl md:text-5xl lg:text-6xl font-black tracking-tight leading-[1.15] mb-6 text-white max-w-3xl">
              Não sabe criar um produto nem onde vender? <span className="text-[#FF0000]">Aqui, resolvemos os dois.</span>
            </motion.h1>
            ...
            <motion.div variants={fadeIn} className="flex justify-center w-full mt-2">
              <a href="#planos" className="w-full sm:w-auto">
                <Button size="lg" className="w-full sm:w-auto h-14 px-10 rounded-xl text-lg font-bold bg-[#FF0000] hover:bg-[#CC0000] text-white shadow-[0_0_35px_rgba(255,0,0,0.4)] transition-all border-none">
        ...
        <section id="como-funciona" className="py-24 px-4 border-t border-white/10 bg-[#000000]">
          ...
          <div className="max-w-[1000px] mx-auto grid md:grid-cols-2 gap-6">
            <div className="bg-[#0a0a0a] border border-white/10 rounded-3xl p-10 flex flex-col justify-start relative shadow-xl">
               <div className="text-white/50 text-xs font-bold tracking-wider mb-4">ANTES</div>
               <h3 className="text-2xl font-bold text-white mb-8">Uma ideia solta</h3>
               <ul className="space-y-4">
                 <li className="text-white/80 flex items-start gap-3">
                    <span className="mt-1 text-[#FF0000] font-bold">-</span> Não sabe por onde começar a escrever
                 </li>
                 <li className="text-white/80 flex items-start gap-3">
                    <span className="mt-1 text-[#FF0000] font-bold">-</span> Não tem página de vendas nem checkout
                 </li>
                 <li className="text-white/80 flex items-start gap-3">
                    <span className="mt-1 text-[#FF0000] font-bold">-</span> Não sabe como divulgar o produto
                 </li>
                 <li className="text-white/80 flex items-start gap-3">
                    <span className="mt-1 text-[#FF0000] font-bold">-</span> Levaria dias (ou nunca sairia do papel)
                 </li>
               </ul>
            </div>

            <div className="bg-[#FF0000] border border-[#FF0000] rounded-3xl p-10 flex flex-col justify-start relative overflow-hidden shadow-[0_0_45px_rgba(255,0,0,0.35)]">
               <div className="text-white/90 text-xs font-bold tracking-wider mb-4">DEPOIS</div>
               <h3 className="text-2xl font-black text-white mb-8">Um produto pronto para vender</h3>
               <ul className="space-y-5">
                 <li className="text-white flex items-start gap-3 text-lg font-bold tracking-tight">
                    <span className="mt-0.5 text-white font-black">-</span> Ebook completo, escrito pela IA em minutos
                 </li>
                 <li className="text-white flex items-start gap-3 text-lg font-bold tracking-tight">
                    <span className="mt-0.5 text-white font-black">-</span> Página de vendas e checkout já configurados
                 </li>
                 <li className="text-white flex items-start gap-3 text-lg font-bold tracking-tight">
                    <span className="mt-0.5 text-white font-black">-</span> Roteiros de vídeo prontos para gravar
                 </li>
                 <li className="text-white flex items-start gap-3 text-lg font-bold tracking-tight">
                    <span className="mt-0.5 text-white font-black">-</span> Você só precisa revisar e divulgar
                 </li>
               </ul>
            </div>
          </div>
        ...
        {/* SECTION: INTEGRAÇÕES (SEÇÃO CLARA DE CONTRASTE #FFFFFF) */}
        <section className="py-24 px-4 border-t border-black/10 bg-[#FFFFFF] overflow-hidden text-black">
           <div className="max-w-[1000px] mx-auto text-center mb-10">
             <div className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-black/5 px-4 py-1.5 text-xs font-bold text-black/70 mb-6 uppercase tracking-wider">
               INTEGRAÇÕES
             </div>
             <h2 className="font-display text-3xl md:text-4xl font-bold mb-6 text-black">Integrado com as principais plataformas de pagamento do Brasil</h2>
           </div>
           
           <div className="relative flex w-[200%] md:w-auto overflow-hidden py-4 opacity-90">
              <div className="absolute inset-y-0 left-0 w-32 bg-gradient-to-r from-[#FFFFFF] to-transparent z-10" />
              ...
              <div className="flex items-center gap-4 px-4 animate-marquee whitespace-nowrap">
                {["Kiwify", "Cakto", "Hotmart", "Applyfy", "PerfectPay", "Kiwify", "Cakto", "Hotmart", "Applyfy", "PerfectPay"].map((gateway, i) => (
                   <div key={i} className="px-6 py-2.5 rounded-2xl border border-black/10 bg-[#000000] text-white font-bold text-base shadow-sm">
                     {gateway}
                   </div>
                ))}
                {["Kiwify", "Cakto", "Hotmart", "Applyfy", "PerfectPay", "Kiwify", "Cakto", "Hotmart", "Applyfy", "PerfectPay"].map((gateway, i) => (
                   <div key={i+10} className="px-6 py-2.5 rounded-2xl border border-black/10 bg-[#000000] text-white font-bold text-base shadow-sm">
                     {gateway}
                   </div>
                ))}
              </div>
           ...
           <div className="max-w-[1000px] mx-auto text-center mt-6">
             <p className="text-black/60 text-sm font-medium">Configure seu link e comece a vender.</p>
           </div>
        </section>

        {/* SECTION: QUALQUER NICHO */}
        <section className="py-24 px-4 bg-[#000000] border-t border-white/10 overflow-hidden">
           <div className="max-w-[1000px] mx-auto text-center mb-16">
             <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-xs font-bold text-white/70 mb-6 uppercase tracking-wider">
               PARA QUALQUER NICHO
             </div>
           ...
           <div className="relative flex flex-col gap-4 w-[200%] md:w-auto overflow-hidden py-4 opacity-80">
              ...
              <div className="flex items-center gap-4 px-4 animate-marquee-reverse whitespace-nowrap">
                {["Emagrecimento", "Finanças pessoais", "Relacionamento", "Receitas fit", "Marketing digital", "Produtividade", "Emagrecimento", "Finanças pessoais", "Relacionamento", "Receitas fit", "Marketing digital", "Produtividade"].map((nicho, i) => (
                   <div key={`top-${i}`} className="px-6 py-2.5 rounded-full border border-white/10 bg-[#0a0a0a] text-white/80 text-sm font-medium">
                     {nicho}
                   </div>
                ))}
                {["Emagrecimento", "Finanças pessoais", "Relacionamento", "Receitas fit", "Marketing digital", "Produtividade", "Emagrecimento", "Finanças pessoais", "Relacionamento", "Receitas fit", "Marketing digital", "Produtividade"].map((nicho, i) => (
                   <div key={`top-dup-${i}`} className="px-6 py-2.5 rounded-full border border-white/10 bg-[#0a0a0a] text-white/80 text-sm font-medium">
                     {nicho}
                   </div>
                ))}
              </div>
              ...
              <div className="flex items-center gap-4 px-4 animate-marquee whitespace-nowrap">
                {["Espiritualidade", "Pets", "Beleza e autocuidado", "Desenvolvimento pessoal", "Idiomas", "Maternidade", "Espiritualidade", "Pets", "Beleza e autocuidado", "Desenvolvimento pessoal", "Idiomas", "Maternidade"].map((nicho, i) => (
                   <div key={`bot-${i}`} className="px-6 py-2.5 rounded-full border border-white/10 bg-[#0a0a0a] text-white/80 text-sm font-medium">
                     {nicho}
                   </div>
                ))}
                {["Espiritualidade", "Pets", "Beleza e autocuidado", "Desenvolvimento pessoal", "Idiomas", "Maternidade", "Espiritualidade", "Pets", "Beleza e autocuidado", "Desenvolvimento pessoal", "Idiomas", "Maternidade"].map((nicho, i) => (
                   <div key={`bot-dup-${i}`} className="px-6 py-2.5 rounded-full border border-white/10 bg-[#0a0a0a] text-white/80 text-sm font-medium">
                     {nicho}
                   </div>
                ))}
              </div>
        ...
        {/* SECTION: DEPOIMENTOS */}
        <section className="py-24 px-4 border-t border-white/10 bg-[#000000]">
           ...
           <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                { nome: "Felipe", nicho: "Nicho de culinária e receitas", texto: "Minhas vendas dobraram! A copy da página de vendas que o sistema gerou é fora do comum. Perfeito." }
                 ...
                 <div key={i} className="bg-[#0a0a0a] border border-white/10 rounded-3xl p-8 flex flex-col justify-between hover:border-[#FF0000]/30 transition-colors">
                    <div>
                      <div className="text-[#FF0000] font-serif text-5xl h-8 overflow-hidden mb-4">"</div>
                      <p className="text-white/80 text-sm leading-relaxed mb-8">{dep.texto}</p>
                    </div>
                    <div className="flex items-center gap-3">
                       <div className="w-10 h-10 rounded-full bg-[#FF0000] flex items-center justify-center text-white font-bold shrink-0">{dep.nome.charAt(0)}</div>
                       <div>
        ...
        <section id="planos" className="pt-24 pb-12 px-4 relative bg-[#000000] border-t border-white/10">
          ...
          <div className="max-w-[900px] mx-auto grid md:grid-cols-2 gap-6 items-stretch">
               ...
               <ul className="space-y-4 mb-10 flex-1">
                 {["Ebooks ilimitados com IA", "Estrutura e capítulos automáticos", "Página de vendas incluída", "Download em PDF", "Cancele quando quiser, sem multa"].map((item, i) => (
                   <li key={i} className="flex items-start gap-3 text-white/70 text-sm font-medium">
                      <Check className="w-4 h-4 text-[#FF0000] shrink-0 mt-0.5" /> {item}
                   </li>
                 ))}
               </ul>
            ...
            {/* PLANO VITALÍCIO */}
            <div className="bg-[#050505] border-2 border-[#FF0000] rounded-3xl p-8 flex flex-col relative shadow-[0_0_40px_rgba(255,0,0,0.25)] mt-4 md:mt-0">
               <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-[#FF0000] text-white text-[10px] font-bold uppercase tracking-widest px-4 py-1.5 rounded-full whitespace-nowrap shadow-md">
               ...
               <div className="flex items-center justify-center gap-4 mt-6 text-[10px] text-white/50 font-medium">
                  ...
                  <span className="flex items-center gap-1"><ShieldCheck className="w-3 h-3 text-[#FF0000]" /> 7 dias de garantia</span>
               </div>
            </div>
          </div>
        </section>
        ...
        <section className="pb-24 px-4 bg-[#000000]">
           <div className="max-w-[900px] mx-auto bg-[#0a0a0a] border border-[#FF0000]/40 rounded-2xl p-6 md:p-8 flex items-start gap-4 shadow-[0_0_30px_rgba(255,0,0,0.15)]">
              <ShieldCheck className="w-8 h-8 text-[#FF0000] shrink-0 mt-1" />
              <div>
                <h4 className="text-[#FF0000] font-bold text-lg mb-2">Risco zero: 7 dias de garantia</h4>
                <p className="text-white/70 text-sm leading-relaxed">Teste a plataforma por 7 dias. Se não for pra você, é só pedir e devolvemos 100% do seu dinheiro. Sem perguntas, sem burocracia, você só tem a ganhar! Comece hoje mesmo.</p>
              </div>
           </div>
        </section>

        {/* FAQ SECTION */}
        <section id="faq" className="py-24 px-4 border-t border-white/10 bg-[#000000]">
           <div className="max-w-[800px] mx-auto">
              <div className="text-center mb-12">
                 <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-xs font-bold text-[#FF0000] mb-6 uppercase tracking-wider">
                   DÚVIDAS
                 </div>
        ...
        {/* FINAL CTA SECTION */}
        <section className="py-32 px-4 relative overflow-hidden bg-[#000000] border-t border-white/10">
           <div className="absolute top-0 -left-[10%] w-[600px] h-[300px] bg-red-600/[0.08] blur-[150px] rounded-[100%] rotate-45 pointer-events-none" />
           <div className="absolute bottom-0 -right-[10%] w-[500px] h-[200px] bg-red-500/[0.06] blur-[120px] rounded-[100%] -rotate-45 pointer-events-none" />
           
           <div className="max-w-[800px] mx-auto text-center relative z-10">
              <h2 className="font-display text-4xl md:text-5xl font-black mb-6 text-white leading-tight">
                 Seu próximo produto digital <span className="text-[#FF0000]">começa agora, não amanhã.</span>
              </h2>
              ...
              <a href="#planos">
                 <Button size="lg" className="h-16 px-10 rounded-xl text-lg font-bold bg-[#FF0000] hover:bg-[#CC0000] text-white shadow-[0_0_45px_rgba(255,0,0,0.45)] transition-all border-none">
