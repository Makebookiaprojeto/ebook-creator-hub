...
export function SupportView() {
  ...
  return (
    <div className="space-y-6 animate-fade-in sm:-mt-6 mt-0">
      <div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-5">
        <div className="lg:col-span-3 rounded-2xl border border-[#FF0000] bg-card p-6 shadow-[0_0_18px_rgba(255,0,0,0.35)]">
        ...
        <div className="lg:col-span-2 rounded-2xl border border-[#FF0000] bg-card p-6 shadow-[0_0_18px_rgba(255,0,0,0.35)]">
