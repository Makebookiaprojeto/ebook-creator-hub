...
export function CreateEbookView() {
  ...
  useEffect(() => {
    ...
    const alignPreviewToTop = () => {
      ...
      const extraOffset = 20; // para ~20px acima do topo da prévia
          ...
          >
            ...
            {step === 3 && (
              <div key="step3-container" className="space-y-6 -mt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 w-full max-w-6xl mx-auto pt-6 items-stretch">
                  <div className="flex flex-col justify-center space-y-6 py-6 h-full">
                    <div>
