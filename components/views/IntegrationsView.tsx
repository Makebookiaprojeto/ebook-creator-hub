    ...
    <div className="space-y-12 animate-fade-in -mt-6">
      ...
      <div className="flex flex-wrap justify-center items-center gap-10 pt-16">
        <div className="rounded-2xl border bg-card p-8 shadow-[0_0_18px_rgba(212,175,55,0.35)]">
          <img src={caktoLogo} alt="Cakto" loading="eager" decoding="sync" fetchPriority="high" className="h-48 w-auto object-contain rounded-lg" />
        </div>
        <div className="rounded-2xl border bg-card p-8 shadow-[0_0_18px_rgba(212,175,55,0.35)]">
          <img src={kiwifyLogo} alt="Kiwify" loading="eager" decoding="sync" fetchPriority="high" className="h-48 w-auto object-contain rounded-lg" />
        </div>
      </div>
    </div>
  );
