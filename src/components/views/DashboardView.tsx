  ...
  return (
    <div className="space-y-3 animate-fade-in py-1 sm:-mt-6 mt-0">
      ...
      <div className="space-y-3">
        <div className="relative overflow-hidden rounded-3xl border border-red-500/20 dark:border-white/10 bg-white dark:bg-black dark:bg-none px-7 pt-3 pb-7 shadow-[0_10px_40px_-10px_rgba(212,175,55,0.3)]">
                  ...
                  return (
                    <button
                      ...
                      className={`px-2.5 py-1 rounded-full text-[11px] font-medium transition-all border ${
                        active
                          ? "bg-black text-white border-white/50 shadow-sm"
                          : "bg-black text-white border-white/10 hover:border-white/25"
                      }`}
                    >
                      {opt.label}
                    </button>
        ...
        <div className="grid grid-cols-2 gap-3 pt-1">
          <div className="relative overflow-hidden rounded-3xl border border-red-500/20 dark:border-white/10 bg-white dark:bg-black dark:bg-none px-4 py-5 shadow-[0_10px_40px_-10px_rgba(212,175,55,0.3)]">
...
function SalesByHourChart({ total }: { total: number }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-red-500/20 dark:border-white/10 bg-white dark:bg-black dark:bg-none p-5 shadow-[0_10px_40px_-10px_rgba(212,175,55,0.3)]">
